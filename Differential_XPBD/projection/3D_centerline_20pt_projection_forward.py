...
if __name__ == '__main__':
    ...
    start_frame = 30  #
    end_frame = 31
    save_dir = "../DATA/save_loss_withConstConvergency/Foward/" + cal_loss_method + "/" + cal_loss_target
    use_2D_centerline = False  #To judge whether we need to load the 2D centerline Data

    ## ================================================================================
    #    Data for backward
    ## ================================================================================
    LR_RATE = 0.005  #The learning rate for the optimization(15 to 48:0.005,49 to :0.0005,50:0.01)
    ...
    ## ===========================================================
    visulization_loss_type = "projection"
