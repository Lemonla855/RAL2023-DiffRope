...
if __name__ == '__main__':
    ...
    start_frame = 50  #
    end_frame = 61
    save_dir = "../DATA/save_loss_withConstConvergency/XPBD/" + cal_loss_method + "/" + cal_loss_target
    use_2D_centerline = False  #To judge whether we need to load the 2D centerline Data

    ## ================================================================================
    #    Data for backward
    ## ================================================================================
    LR_RATE = 0.03  #The learning rate for the optimization(15 to 48:0.005,49 to 56 :0.0005,56:0.003)
   ...
   ## ================================================================================
    ...
    PyElasticaRendering_OUTPUT_VIDEO_Path = "../DATA/PyElastica/PyElasticaRenderingVideo/XPBD/" + cal_loss_method + "_" + cal_loss_target  #The path to output the video
    PyElasticaRendering_OUTPUT_VIDEO_Name = cal_loss_method + "_" + cal_loss_target  #The path to output the video
    PyElasticaRendering_OUTPUT_IMAGES_DIR = "../DATA/PyElastica/PyElasticaRenderingImage/XPBD/" + cal_loss_method + "_" + cal_loss_target  #The path to ouput the image
