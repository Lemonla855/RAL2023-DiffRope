...
if __name__ == '__main__':
    ...
    start_frame = 16  #
    end_frame = 66
    save_dir = "../DATA/save_loss_withConstConvergency/" + cal_loss_method + "/" + cal_loss_target + "_Terrible"
    ...
    ITERATION = 1  #The nmber of interation to optimize
    ...
    index_draw_pclpbdcenterline = [
        30, 37, 42, 47, 52
    ]  # The index must between 16 to 65, this index is for pcl and PBD and Simulation result #30,37,42,47,52
    ...
    PyElasticaRendering_OUTPUT_VIDEO_Path = "../DATA/PyElastica/PyElasticaRenderingVideo/" + cal_loss_method + "_" + cal_loss_target + "_Terrible"  #The path to output the video
    PyElasticaRendering_OUTPUT_VIDEO_Name = cal_loss_method + "_" + cal_loss_target  #The path to output the video
    PyElasticaRendering_OUTPUT_IMAGES_DIR = "../DATA/PyElastica/PyElasticaRenderingImage/" + cal_loss_method + "_" + cal_loss_target + "_Terrible"  #The path to ouput the image
