...
class PBDRope():
    def __init__(self, start_frame, end_frame, save_dir, LR_RATE, LAYERS,
        ...
        ## ------- Constraints stiffness -------
        self.w_gravity = 2.0 / self.STEPS * 10
...
class ProcessOptData():
    ...
    def SaveTempData(self, loss_temp, C_dis, C_strain, C_bending, itr, j, i,
        ...
        np.save(
            "../DATA/CompareOverXPBDAndTomas/" + cal_loss_method + "_" +
            cal_loss_target + "_" + cal_loss_target + str(itr) + "_" + str(j) +
            "_" + str(i) + ".npy", Save_Temp_Data)
