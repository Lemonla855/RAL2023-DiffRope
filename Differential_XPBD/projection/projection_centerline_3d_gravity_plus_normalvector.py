...
if __name__ == '__main__':
    ...
    cal_loss_target = "centerline_3d_gravity_plus_normalvector"
    ...
    #    Data for backward
    ## ================================================================================
    LR_RATE = 0.005  #The learning rate for the optimization(15 to 48:0.005,49 to :0.0005,50:0.01) #For 51 to 58, learning rate is 0.001
    ...
    index_draw_pclpbdcenterline = [
        16, 21, 26, 31, 36, 41, 46, 51, 56, 61, 64
    ...
    #vis.RealtoSimFigure(visulization_loss_type)
