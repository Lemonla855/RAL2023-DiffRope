...
if __name__ == '__main__':
    ...
    start_frame = 56  #
    end_frame = 66
    save_dir = "../DATA/save_loss_withConstConvergency/dynamics/" + cal_loss_method + "/" + cal_loss_target
    use_2D_centerline = True  #To judge whether we need to load the 2D centerline Data

    ## ================================================================================
    #    Data for backward
    ## ================================================================================
    LR_RATE = 0.001  #The learning rate for the optimization(15 to 48:0.005,49 to :0.0005,50:0.01)
    ...
    ## ===========================================================
    visulization_loss_type = "dynamics/" + cal_loss_method + "/" + cal_loss_target
    ...
    savefig_PCLPBDCenterline_path = "dynamics" + cal_loss_method + "/" + cal_loss_target  #Path to save the PCLPBDCenterline plot
    RealtoSimFigure_name = "dynamics" + cal_loss_method + "_" + cal_loss_target
    # ## ================================================================================
    ...
    #  Execute the solve
    # ================================================================================
    # Solver = PBDRope_dynamics.ExecuteBackward()
