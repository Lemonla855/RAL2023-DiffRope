...
sys.path.append("..")
from script import PBDRope_MPC
...
if __name__ == '__main__':
    ...
    start_frame = 31  #
    end_frame = 66
    save_dir = "../DATA/save_loss_withConstConvergency/MPC/" + cal_loss_method + "/" + cal_loss_target
    use_2D_centerline = False  #To judge whether we need to load the 2D centerline Data

    ## ================================================================================
    #    Data for backward
    ## ================================================================================
    LR_RATE = 0.02  #The learning rate for the optimization(15 to 48:0.005,49 to 56 :0.0005,56:0.003)
    LAYERS = 12  #The number of steps to update other constraint in a step
    STEPS = 30  #The steps  to update the gravity?
    ITERATION = 80  #The nmber of interation to optimize
    ...
    ## ================================================================================
    save_loc_analysis = "../DATA/MPC/" + cal_loss_method + "/" + cal_loss_target
    ...
    #  Execute the solve
    #================================================================================
    Solver = PBDRope_MPC.ExecuteBackward()
